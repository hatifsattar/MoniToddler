...
//        if (actionBar!= null){
//            actionBar.setLogo(R.drawable.mt_icon_round_2);
...
//        }
    ...
    private void update_params_activity() {
        Intent myIntent = new Intent(this, UpdateParams.class);
        startActivity(myIntent);
    }
